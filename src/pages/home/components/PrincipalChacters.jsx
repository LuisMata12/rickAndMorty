  ...
  return (
    ...
    <div className='text-center mt-5'>
        <div className='row mt-2'>
            <img src="https://www.nacionflix.com/__export/1657911336768/sites/debate/img/2021/07/20/rick4_2.jpg_1339198940.jpg" className='col-lg-5 rounded-5' alt="rick" />
            <div className='d-flex flex-column align-items-center col-lg-7'>
